      ...
      <div className="bg-white rounded-xl max-w-lg w-full shadow-2xl border border-slate-200 overflow-hidden relative">
        ...
        <div className="bg-slate-900 text-white p-6 relative border-b border-slate-800">
          <button
            ...
            className="absolute top-4 right-4 p-1 rounded text-slate-400 hover:text-white hover:bg-white/10 transition"
          ...
          <div className="flex items-center gap-2 mb-1">
            <span className="px-2 py-0.5 rounded bg-violet-600 text-white font-bold text-[10px] uppercase tracking-widest">
          ...
          <p className="text-xs text-slate-400 mt-1">
            Convert 1 Zapier automation connecting up to 2 apps at zero cost.
          </p>
        </div>
          ...
          {isSuccess ? (
            <div className="text-center py-6 space-y-4">
              ...
              <div className="space-y-1">
                <h4 className="text-lg font-extrabold uppercase text-slate-900 tracking-tight">
                  Request Confirmed!
                </h4>
              ...
              <div className="bg-slate-50 p-4 rounded-lg text-left border border-slate-200 text-xs space-y-1.5 font-mono">
                <div className="font-bold text-slate-800 border-b border-slate-200 pb-1 uppercase font-sans text-[10px] tracking-widest">
                  Submission Summary:
                </div>
              ...
              <div className="pt-2 flex flex-col gap-2">
                <a
                  ...
                  className="w-full py-3 px-4 bg-violet-600 hover:bg-violet-500 text-white font-bold text-xs uppercase tracking-wider rounded-lg flex items-center justify-center gap-2 transition"
                >
                ...
                <button
                  onClick={handleResetAndClose}
                  className="w-full py-2.5 px-4 bg-slate-100 hover:bg-slate-200 text-slate-700 font-bold text-xs uppercase tracking-wider rounded-lg"
                >
                  Close Window
                </button>
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="bg-slate-50 border border-slate-200 p-3 rounded-lg flex items-center justify-between text-xs text-slate-800 font-mono">
                ...
                <span className="text-[10px] text-slate-600 bg-slate-200 px-2 py-1 rounded font-bold uppercase tracking-wider">
              ...
              {/* Input 1: Name */}
              <div className="space-y-1">
                <label htmlFor="lead-name" className="block text-[10px] font-bold text-slate-400 uppercase tracking-widest">
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 rounded-lg border border-slate-300 text-slate-900 text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-violet-500 shadow-xs"
                />
              </div>

              {/* Input 2: Email */}
              <div className="space-y-1">
                <label htmlFor="lead-email" className="block text-[10px] font-bold text-slate-400 uppercase tracking-widest">
              ...
              {/* Input 3: Workflow explanation */}
              <div className="space-y-1">
                <label htmlFor="lead-workflow" className="block text-[10px] font-bold text-slate-400 uppercase tracking-widest">
                  Simple Zapier Workflow Description <span className="text-red-500">*</span>
                </label>
                <textarea
                  id="lead-workflow"
                  rows={3}
                  ...
                  placeholder="Describe your simple zap connecting up to 2 apps (e.g. Typeform to Slack/HubSpot)."
                  className="w-full px-3.5 py-2.5 rounded-lg border border-slate-300 text-slate-900 text-xs focus:outline-none focus:ring-2 focus:ring-violet-500 resize-none shadow-xs"
                />
              </div>
              ...
              <div className="pt-2">
                <button
                  ...
                  className="w-full py-3.5 px-4 bg-violet-600 hover:bg-violet-500 text-white font-bold text-xs uppercase tracking-widest rounded-lg shadow-md flex items-center justify-center gap-2 transition disabled:opacity-50"
                  id="submit-migration-form-btn"
                >
                  {isSubmitting ? (
